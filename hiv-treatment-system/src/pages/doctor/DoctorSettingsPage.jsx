...
const DoctorSettingsPage = () => {
  const [settings, setSettings] = useState({
    ...
    email: 'bs.lethiminh@example.com',
    phone: '(123) 456-7893',
    language: 'vi',
    notifications: {
      email: true,
  ...
  return (
    <Layout currentRole={UserRole.DOCTOR} userName={settings.fullName}>
        ...
        <div className="space-y-6">
          ...
          <Card title="Giờ làm việc">
            <div className="p-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1" htmlFor="workingHours.start">
                    Giờ bắt đầu
                  </label>
                  <input
                    type="time"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1" htmlFor="workingHours.end">
                    Giờ kết thúc
                  </label>
                  <input
                    type="time"
              ...
              <div className="mt-4">
                <div className="flex items-center">
                  <input
                    id="autoAcceptAppointments"
                    name="autoAcceptAppointments"
                    type="checkbox"
                    checked={settings.autoAcceptAppointments}
                    onChange={handleSettingsChange}
                    className="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded"
                  />
                  <label htmlFor="autoAcceptAppointments" className="ml-2 block text-sm text-gray-700">
                    Tự động chấp nhận lịch hẹn
                  </label>
                </div>
              </div>
            </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center">
                      <input
                        ...
                        className="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded"
                      />
                      <label htmlFor="notifications.appointments" className="ml-2 block text-sm text-gray-700">
                        Lịch hẹn mới và thay đổi
                      </label>
                    </div>
                    <div className="flex items-center">
                      <input
                        ...
                        className="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded"
                      />
                      <label htmlFor="notifications.results" className="ml-2 block text-sm text-gray-700">
